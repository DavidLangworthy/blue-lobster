...
set_gh_variable "${REPO}" "DEPLOY_AZURE_OPENAI_MODEL" "true"
set_gh_variable "${REPO}" "AZURE_OPENAI_SKU_NAME" "S0"
set_gh_variable "${REPO}" "AZURE_OPENAI_MODEL_NAME" "gpt-4.1"
set_gh_variable "${REPO}" "AZURE_OPENAI_MODEL_VERSION" "2025-04-14"
set_gh_variable "${REPO}" "AZURE_OPENAI_DEPLOYMENT_SKU_NAME" "Standard"
set_gh_variable "${REPO}" "AZURE_OPENAI_DEPLOYMENT_SKU_CAPACITY" "1"
